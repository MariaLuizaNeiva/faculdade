...
public class ControladorGravar implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (cboFabricante.getSelectedIndex() == 0) {
			JOptionPane.showMessageDialog(null, "Faricante obrigatório !");
			return;
		}
		...
		if (cboCor.getSelectedIndex() == 0) {
			JOptionPane.showMessageDialog(null, "Cor obrigatório !");
			return;
		}
		...
		JOptionPane.showMessageDialog(null,
				"Gravação realizada com suceso !!!\n\n" +
				"Fabricante: " + objVeiculo.getObjFabricante()
											.getNome() + "\n" +
				"Modelo: " + objVeiculo.getModelo() + "\n" +
				"Cor: " + objVeiculo.getCor() + "\n" +
				"Teto Solar: " + (objVeiculo.isTetoSolar() ?
						         "SIM" : "NÃO"));	
	}
}
